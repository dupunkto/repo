...
inherit epyrus-5 git-r3 flag-o-matic pax-utils xdg

KEYWORDS="~amd64 ~x86"
DESCRIPTION="The idealized e-mail client and companion to Pale Moon."
...
EGIT_REPO_URI="https://repo.palemoon.org/athenian200/epyrus.git"
EGIT_COMMIT="Epyrus${PV}_Release"
...
src_install() {
	...
	pax-mark m "${D}/${dest_libdir}/${PN}/"{epyrus,plugin-container}
